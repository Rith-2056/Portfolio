...
export const mat = {
  ...
  carPanel: std({ color: "#24272d", flatShading: true, roughness: 0.5, metalness: 0.06 }),
  carTrim: std({ color: "#3c414a", flatShading: true, roughness: 0.5, metalness: 0.12 }),
  tire: std({ color: "#101114", flatShading: true, roughness: 1, metalness: 0 }),
  rim: std({ color: "#4e545e", flatShading: true, roughness: 0.45, metalness: 0.2 }),
